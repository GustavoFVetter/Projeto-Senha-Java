...
public class AdministracaoView extends javax.swing.JFrame {
    ...
    private void jButtonCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastroActionPerformed
        ...
        if (nome.equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(this, "Informe um nome para "
                    + "cadastrar uma senha");
            ...
            jLabelSenhaCadastrada.setText("Cadastrado: " + senha + " - "
                    + atendimento.getNome());
    ...
    private void jButtonProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonProximoActionPerformed
        ...
        AtendimentoController atController = new AtendimentoController();
        //Atualiza a senha que estava em atendimento para senhas já chamadas
        ...
        if (atendimento != null) {
            ...
            // Atualiza a data/hora que a pessoa foi chamada
            atendimento.setAtendimento(new Date());
            // Efetiva as alterações no DB
            atController.update(atendimento);
            jLabelSenhaChamada.setText("Última senha chamada: "
                    + atendimento.getId() + " - " + atendimento.getNome());
        } else {
            jLabelSenhaChamada.setText("Não há clientes na fila nesse momento.");
        }
