...
public class AtendimentoView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelSenha.setFont(new java.awt.Font("Verdana", 1, 24)); // NOI18N
        jLabelSenha.setForeground(new java.awt.Color(153, 0, 153));
        ...
        jLabelNome.setForeground(new java.awt.Color(153, 0, 153));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLabelNome, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
            ...
            public void run() {
                while (true) {
                    ...
                    try {
                        ...
                        Logger.getLogger(AtendimentoView.class.getName())
    ...
    public void atualizaPainelSenha() {
        ...
        if (atModel != null) {
            ...
            jLabelSenha.setText("Pegue sua senha e");
            jLabelNome.setText("aguarde ser chamado.");
        }
    }

    public void atualizaPainel(DefaultListModel listModel,
            List<AtendimentoModel> listAtendimentoModel) {

        // Atualiza os models somente se ocorreu alguma alteração, para evitar 
        // do painel ficar "piscando" a cada segundo
        if (listAtendimentoModel.isEmpty()) {
            ...
            if (listModel.isEmpty()) {
                ...
                if ((listAtendimentoModel.get(0).getId() != ((AtendimentoModel) 
                        listModel.get(0)).getId())
                        || (listAtendimentoModel.size() != listModel.getSize())) {
                    listModel.clear();
                    for (AtendimentoModel at : listAtendimentoModel) {
                        listModel.addElement(at);
                    }
